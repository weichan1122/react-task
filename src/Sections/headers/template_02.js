...
const lngs = {
  en: { nativeName: 'English' ,icon:'img/header/language/en.png' },
  bm: { nativeName: 'Malay' ,icon:'img/header/language/ms.png'},
  zh: { nativeName: '中文',icon:'img/header/language/zh.png' }
};
...
const menuData = [
  {
    name: "home",
    icon: "img/header/menu/menu_home.png",
    dropdown: false,
    link: "",
  },
  ...
  {
    name: "slot",
    icon: "img/header/menu/menu_slot.png",
    dropdown: true,
    link: "slots",
  },
  ...
  {
    name: "live_casino",
    icon: "img/header/menu/menu_casino.png",
    dropdown: false,
    link: "casino",
  },
  ...
  {
    name: "promotion",
    icon: "img/header/menu/menu_promo.png",
    dropdown: false,
    link: "promotions",
  },
  ...
  {
    name: "help",
    icon: "img/header/menu/menu_help.png",
    dropdown: false,
    link: "help",
  },
  ...
  {
    name: "vip",
    icon: "img/header/menu/menu_vip.png",
    dropdown: false,
    link: "vip",
  },
  ...
  {
    name: "mall",
    icon: "img/header/menu/menu_mall.png",
    dropdown: false,
    link: "mall",
  },
];
    ...
    <>
      <div className="d-none d-lg-block">
        <div className="font_h5 language_header">
          <img src={"https://ocwin.com/assets/img/header/"+(i18n.resolvedLanguage == "en" ? "en" : (i18n.resolvedLanguage == "bm" ? "bm" : "cn"))+".png"} alt="language flag" />
